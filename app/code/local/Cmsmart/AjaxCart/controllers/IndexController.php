				...
				<li class="success-msg">
					...
					<ul>
						...
						<li><span><a title="'.@$product->getName().'" href="'.@$product->getProductUrl().'">'.@$product->getName().' </a> '.$this->__('has been added to cart').'.</span></li>
						 ...
						 <li>'.((@$product->getData('golu_dolls_disclaimer')=="") ? "" : '<b>Terms and Conditions for Pre Orders</b><br/>
1. The images displayed for most of the Kolu bommai’s are SAMPLE Image only, to give a idea about how the bommai/doll would appear.<br/>
2. The images displayed for most of the Kolu bommai’s are SAMPLE Image only, to give an idea about the number of individual bommai that bommai set will consist.<br/>
3. The images displayed for most of the Kolu bommai’s are SAMPLE Image only, to give an idea about the theme/concept of each of the kolu bommai<br/>
4. All dispatches will be done before the start of Mahalayam<br/>
5. The payment made while placing order is towards the Product cost ONLY.<br/>
6. Packing and shipping charges will be charged at actuals<br/>
7. Packing and shipping will be determined and updated via email once product is received<br/>
8. For Other country Orders, Duty and taxes applicable at destination will be borne as usual by Consignee/Receiver<br/>
9. A pre booked order cannot be cancelled or exchanged as the stocks are procured against the order placed<br/>
10. As a Special case, exchange/replacement of 1 or 2 products will be accepted if the count of individual products per order is 10 and above.<br/> 
11. All Orders are placed, against your acceptance to the above and the general terms and conditions applicable for Online purchase made through www.giri.in').'</li>
			...
			'. $this->getLayout()->createBlock('checkout/cart_crosssell')->setTemplate('checkout/cart/crosssell.phtml')->toHtml().'
			</div>
